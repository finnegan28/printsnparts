      ...
      <article className="bg-white shadow-md rounded-lg p-6 max-w-3xl w-full">
        ...
        <section className="mb-8 text-lg">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            My name is Neil, and I have been 3d printing for many years. I have a background in software engineering and I have a big passion for making things.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            A few years ago my Audio Technica headphones broke. Reluctant to buy a new pair after almost 10 years of use, I came up with a few solutions and eventually 3d printed a small bracket to repair them.
          </p>
        </section>
        ...
        <section className="mb-8 text-lg">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            I realised that many different headphone models had similar issues and there was a huge need for this type of repair. The build quality of consumer electronics often leaves much to be desired, and replacement parts are not readily available.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
